...
Namespace MultipleORMsExample.Web
    ...
    Public Partial Class MultipleORMsExampleAspNetApplication
        ...
        Private module3 As [Module].MultipleORMsExampleModule
        ...
        Private Sub MultipleORMsExampleAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
        ...
        Private Sub InitializeComponent()
            ...
            module3 = New [Module].MultipleORMsExampleModule()
            sqlConnection1 = New Data.SqlClient.SqlConnection()
            CType(Me, System.ComponentModel.ISupportInitialize).BeginInit()
            ' 
            ' sqlConnection1
            ' 
            sqlConnection1.ConnectionString = "Integrated Security=SSPI;Pooling=false;Data Source=.\SQLEXPRESS;Initial Catalog=MultipleORMsExample"
            sqlConnection1.FireInfoMessageEventOnUserErrors = False
            ' 
            ' MultipleORMsExampleAspNetApplication
            ' 
            ApplicationName = "MultipleORMsExample"
            Connection = sqlConnection1
            Modules.Add(module1)
            Modules.Add(module2)
            Modules.Add(module3)
            AddHandler DatabaseVersionMismatch, New EventHandler(Of DatabaseVersionMismatchEventArgs)(AddressOf MultipleORMsExampleAspNetApplication_DatabaseVersionMismatch)
